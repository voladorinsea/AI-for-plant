...
MOVEBAR_CARD_FRESH_TIME = 6000 // accelerate
CARD_MOVE_TIME = 60 // accelerate
...
PRODUCE_SUN_INTERVAL = 7000 // accelerate
FLOWER_SUN_INTERVAL = 22000 // accelerate
# SUN_LIVE_TIME = 7000
SUN_VALUE = 25

ICE_SLOW_TIME = 2000 // accelerate

FREEZE_TIME = 7500 // accelerate
ICETRAP = 'IceTrap'
...
ATTACK_INTERVAL = 1000 // accelerate
ZOMBIE_WALK_INTERVAL = 70 # not accelate because has accelate the speend of zombie
